 ...
 */
function replace(word: string, rule: RegExp, ...params: string[]) {
 ...
 */
function sanitizeWord(token: string, word: string, rules: RegExp[]) {
 ...
 */
function replaceWord(replaceMap: object, keepMap: object, rules: RegExp[]) {
